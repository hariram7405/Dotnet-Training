   ...
   public class RoomRepository:IRepository<Room>
    {
        ...
        public async Task<Room?> GetFirstAvailableStaffAsync() => throw new NotImplementedException();
        public async Task<Room?> GetFirstAvailableRoomAsync()
        {
            return await _context.Rooms.Include(r => r.Students)
                .Where(r => r.Students.Count < r.Capacity)
                .OrderBy(r => r.RoomId)
                .FirstOrDefaultAsync();
        }
        public async Task<Room?> GetByUsernameAsync(string username) => throw new NotImplementedException();
